...
<!-- Plugins js -->
<script src="<?= base_url() ?>assets/backend/plugins/timepicker/moment.js"></script>
<script src="<?= base_url() ?>assets/backend/plugins/timepicker/tempusdominus-bootstrap-4.js"></script>
<script src="<?= base_url() ?>assets/backend/plugins/timepicker/bootstrap-material-datetimepicker.js"></script>
<script src="<?= base_url() ?>assets/backend/plugins/colorpicker/jquery-asColor.js"></script>
<script src="<?= base_url() ?>assets/backend/plugins/colorpicker/jquery-asGradient.js"></script>
<script src="<?= base_url() ?>assets/backend/plugins/colorpicker/jquery-asColorPicker.min.js"></script>
<script src="<?= base_url() ?>assets/backend/plugins/select2/select2.min.js"></script>

<script src="<?= base_url() ?>assets/backend/plugins/bootstrap-colorpicker/js/bootstrap-colorpicker.min.js"></script>
<script src="<?= base_url() ?>assets/backend/plugins/bootstrap-datepicker/js/bootstrap-datepicker.min.js"></script>
<script src="<?= base_url() ?>assets/backend/plugins/bootstrap-maxlength/bootstrap-maxlength.min.js"></script>
<script src="<?= base_url() ?>assets/backend/plugins/bootstrap-touchspin/js/jquery.bootstrap-touchspin.min.js"></script>
<script src="<?= base_url() ?>assets/backend/plugins/bootstrap-inputmask/bootstrap-inputmask.min.js"></script>
<script src="<?= base_url() ?>assets/backend/plugins/dropzone/dist/dropzone.js"></script>

<!-- Plugins Init js -->
<script src="<?= base_url() ?>assets/backend/pages/form-advanced.js"></script>
