    ...
    <div class="container-fluid">
            ...
            <div class="col-12">
                <div class="card m-b-30">
                    <div class="card-body">
                        ...
                        <p class="text-muted font-14">Here are examples of <code class="highlighter-rouge">.form-control</code> applied to each
            ...
            <div class="col-12">
                <div class="card m-b-30">
                    <div class="card-body">
                        ...
                        <p class="text-muted font-14">Set heights using classes like
            ...
            <div class="col-md-12 col-xl-6">
                <div class="card m-b-30">
                    <div class="card-body">
                        ...
                        <p class="text-muted font-14">For even more customization and cross browser consistency, use our completely custom form elements to replace the browser defaults.
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="mt-0 header-title">Input groups</h4>
                        <p class="text-muted font-14">Easily extend form controls by adding text, buttons,
                            or button groups on either side of textual inputs, custom selects, and custom file inputs.</p>
                        <div class="general-label">
                            <form class="form-horizontal">
                                <div class="form-group row">
