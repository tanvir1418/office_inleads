<div class="modal edit_salary_type" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <form action="<?= base_url() ?>super_admin/edit_salary_type/salary_type" method="post" enctype="multipart/form-data">
